 ...
 * @author casti
 */
public class Priority1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Object[] columns = { "         PROCESS", "      BURST TIME","         PRIORITY", "     COMPLETION", "   TURN AROUND", "    WAITING TIME"};
        ...
        jPanel1.add(avewt, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 50, 40, 20));
        ...
        bg.setIcon(new javax.swing.ImageIcon(getClass().getResource("/cpuscheduling/priority.png"))); // NOI18N
        bg.setText("jLabel1");
...
//Priority
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Priority1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
     ...
     public void arrivalSort(){
        ...
        for(int i = 0; i < arrivalTime.size(); i++){
            for(int j = i+1; j < arrivalTime.size(); j++){
                if(arrivalTime.get(i)  > arrivalTime.get(j)){
                   
                    x = arrivalTime.get(i);                        // x-temporary container
                    arrivalTime.set(i,arrivalTime.get(j));         //put at[j] to at[i]
                    arrivalTime.set(j,x);                          //put x to j
                    model.setValueAt(arrivalTime.get(i), i, 2);    //put i-row number to at[i] and set to column 2
                    model.setValueAt(arrivalTime.get(j), j, 2);   
                   
                    x = burstTime.get(i);
                    burstTime.set(i,burstTime.get(j));
                    burstTime.set(j,x);
                    model.setValueAt(burstTime.get(i), i, 1);
