 ...
 * @author casti
 */
public class SRTF1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        bg.setIcon(new javax.swing.ImageIcon(getClass().getResource("/cpuscheduling/sjfp.png"))); // NOI18N
        bg.setText("jLabel1");
    ...
    private void addActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addActionPerformed
        ...
        holder++;
        //set holder value to row index
        row[0] = Integer.toString(holder);
...
//SRTF
    private void computeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_computeActionPerformed
        //Compute button
          ...
          int bTemp[] = new int[burstTime.size()];
          for(int i = 0; i < burstTime.size(); i++){
            bTemp[i] = burstTime.get(i);
          }
        
           
           
        while (complete != burstTime.size()) { 
       
            for (int j = 0; j < burstTime.size(); j++)  
            { 
                if ((arrivalTime.get(j) <= t) && 
                  (bTemp[j] < minm) && bTemp[j] > 0) { 
                    minm = bTemp[j]; 
                    shortest = j; 
                    
                    if(ctr == 0|| minm > lk[ctr-1] || minm != lk[ctr-1])
                    {
                        uk[ctr] = shortest;
                        lk[ctr] = t;
                        ctr++;
            ...
            if (bTemp[shortest] == 0) { 
                ...
                finish_time = t + 1; 
                completionTime[shortest] = finish_time;
                waitingTime[shortest] = finish_time - 
                             burstTime.get(shortest) - 
                             arrivalTime.get(shortest); 
                list1.add(processNo.get(shortest));
              //  list2.add(completionTime[shortest]);
                list2.add(t);
        ...
        for(int i = 0; i < processNo.size(); i++)
            System.out.println("P: " + processNo.get(i));
        
        for (int i = 0; i < burstTime.size(); i++) 
            turnaroundTime[i] = burstTime.get(i) + waitingTime[i]; 
...
public void ganttchart(int uk_hold[], int lk_hold[])
{
    for(int i = 0; i <=(ctr-1);i++)
    {
        System.out.println("P" + (uk_hold[i]+1) + " : " + lk_hold[i+1]);
    }
}
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SRTF1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
